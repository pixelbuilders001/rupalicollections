...
import { useRecentlyViewed, RecentlyViewed } from "./RecentlyViewed";
            ...
            <div>
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                        {product.stock === 0 && (
                            <span className="bg-red-600 text-white text-[10px] font-bold px-2 py-0.5 rounded-full uppercase tracking-widest shadow-sm">Sold Out</span>
                        )}
                    ...
                    <div className="container mx-auto max-w-7xl flex items-center gap-3 md:flex-row-reverse md:gap-4 md:px-0">
                        ...
                        <div className="flex flex-1 gap-2.5 md:flex-col md:gap-4">
                            ...
                            */}
                            ...
                            <Button
                                variant="outline"
                                className="hidden md:flex h-12 w-full rounded-2xl text-sm font-bold uppercase tracking-wider border-2 border-green-100 bg-green-50 text-green-600 hover:bg-green-100/80"
                                onClick={handleShare}
                            >
                                Share on WhatsApp <svg className="ml-2 h-4 w-4 fill-current" viewBox="0 0 24 24">
                        ...
                        <Button
                            variant="secondary"
                            size="icon"
                            className="h-14 w-14 shrink-0 rounded-2xl transition-all active:scale-95 border-2 border-green-100 bg-green-50 text-green-600 shadow-sm md:hidden"
                            onClick={handleShare}
                        >
